...
import type { PipelineStage, PipelineStatus, StageResult, PipelineExecutionContext } from './multi-stage.js';
...
export interface PipelineProgress {
  ...
  readonly phase: 'initializing' | 'executing' | 'reviewing' | 'completing' | 'error_handling';
...
export interface BottleneckAnalysis {
  ...
  /** Bottleneck type */
  readonly type: 'execution_time' | 'token_usage' | 'retry_count' | 'validation_time' | 'dependency_wait';
...
export interface OptimizationOpportunity {
  /** Opportunity type */
  readonly type: 'parallel_execution' | 'session_reuse' | 'prompt_optimization' | 'retry_reduction' | 'caching';
 ...
 */
export type ProgressUpdateCallback = (snapshot: ProgressSnapshot) => void | Promise<void>;
