...
import type { PipelineStage, StageResult, PipelineExecutionContext, StageExecutionMetadata } from './multi-stage.js';
...
export interface ReviewManager {
  ...
  submitReview(reviewId: string, decision: ReviewSubmission): Promise<ReviewResult>;
...
export interface CLIReviewSettings {
  ...
  readonly autoExpand?: ReadonlyArray<'input' | 'output' | 'metadata' | 'errors' | 'history' | 'related'>;
...
export interface WebhookConfiguration {
  ...
  readonly events: ReadonlyArray<'review_requested' | 'review_completed' | 'review_expired' | 'review_escalated'>;
