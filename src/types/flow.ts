...
import type { PipelineStage, PipelineExecutionContext, StageResult } from './multi-stage.js';
...
export interface DependencyGraphNode {
  ...
  readonly status: 'pending' | 'ready' | 'executing' | 'completed' | 'failed' | 'skipped';
...
export interface DAGValidationError {
  /** Error type */
  readonly type: 'circular_dependency' | 'missing_stage' | 'invalid_dependency' | 'unreachable_stage';
...
export interface DAGValidationWarning {
  /** Warning type */
  readonly type: 'orphaned_stage' | 'complex_dependency' | 'performance_concern' | 'redundant_dependency';
...
export interface DAGOptimization {
  /** Optimization type */
  readonly type: 'parallelization' | 'dependency_reduction' | 'critical_path_shortening' | 'resource_optimization';
...
export interface ConditionalBranch {
  readonly condition: (input: unknown, context: PipelineExecutionContext) => boolean | Promise<boolean>;
